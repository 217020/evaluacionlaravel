...
$arrayStudent = ['nombre' => $request->nombre, 'apellido' => $request->apellido, 'email' => $request-
>email, 'telefono' => $request->telefono, 'sexo' => $request->sexo, 'foto' => $fileName];
...
{
$fileName = '';$stud = Student::find($request->student_id);
